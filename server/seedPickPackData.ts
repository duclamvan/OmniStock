...
export async function seedPickPackData() {
  ...
  try {
    ...
    const orderData = [
      // Orders ready for picking (to_fulfill status)
      {
        id: 'ord-pick-1',
      ...
      },
      {
        ...
        shippingCost: '99',
        grandTotal: '2277',
        notes: 'Beauty bundle order - handle with care',
        pickStatus: 'not_started',
        packStatus: 'not_started',
        createdAt: new Date(Date.now() - 3 * 60 * 60 * 1000) // 3 hours ago
      },
      // Order in picking process
      {
        id: 'ord-picking-1',
        orderId: `ORD-${getCurrentDateString()}-${String(orderCounter++).padStart(3, '0')}`,
        customerId: 'cust-3',
        ...
        shippingCost: '120',
        grandTotal: '3205.50',
        notes: 'Corporate order - include invoice',
        pickStatus: 'in_progress',
        packStatus: 'not_started',
        pickedBy: 'Employee #001',
        pickStartTime: new Date(Date.now() - 30 * 60 * 1000), // Started 30 mins ago
      ...
      // Order in packing process
      {
        ...
        shippingCost: '200',
        grandTotal: '4435',
        notes: 'FRAGILE: Contains glass items',
        pickStatus: 'completed',
        ...
        packStartTime: new Date(Date.now() - 15 * 60 * 1000), // Started packing 15 mins ago
    ...
    // Create order items including bundles
    const orderItemData = [
      // Order 1 - Tech bundle
      {
        id: nanoid(),
      ...
      // Order 2 - Beauty bundle (all lipstick variants)
      {
        id: nanoid(),
        orderId: 'ord-pick-2',
        productId: 'prod-lipstick',
        variantId: 'var-lips-red',
        productName: 'Luxury Matte Lipstick - Classic Red #001',
        sku: 'LIPS-MAT-001-RED',
        quantity: 1,
        price: '450',
        unitPrice: '450',
        appliedPrice: '450',
        ...
        packedQuantity: 0,
        warehouseLocation: 'B2-R2-S3',
        barcode: '3145891234568'
      },
      {
        id: nanoid(),
        orderId: 'ord-pick-2',
        productId: 'prod-lipstick',
        variantId: 'var-lips-pink',
        productName: 'Luxury Matte Lipstick - Rose Pink #002',
        sku: 'LIPS-MAT-001-PINK',
        quantity: 1,
        price: '450',
        unitPrice: '450',
        appliedPrice: '450',
        ...
        packedQuantity: 0,
        warehouseLocation: 'B2-R2-S3',
        barcode: '3145891234569'
      },
      {
        id: nanoid(),
        orderId: 'ord-pick-2',
        productId: 'prod-lipstick',
        variantId: 'var-lips-nude',
        productName: 'Luxury Matte Lipstick - Natural Nude #003',
        sku: 'LIPS-MAT-001-NUDE',
        quantity: 1,
        price: '450',
        unitPrice: '450',
        appliedPrice: '450',
        ...
        packedQuantity: 0,
        warehouseLocation: 'B2-R2-S3',
        barcode: '3145891234570'
      },
      {
        id: nanoid(),
        orderId: 'ord-pick-2',
        productId: 'prod-lipstick',
        variantId: 'var-lips-berry',
        productName: 'Luxury Matte Lipstick - Berry Blast #004',
        sku: 'LIPS-MAT-001-BERRY',
        quantity: 1,
        price: '450',
        unitPrice: '450',
        appliedPrice: '450',
      ...
      // Order 4 - T-shirt order (ready for packing)
      {
        id: nanoid(),
      ...
      // Order 5 - Fragile item (in packing)
      {
        id: nanoid(),
      ...
      // Order 6 - Multiple items (ready to ship)
      {
        id: nanoid(),
        orderId: 'ord-ready-1',
        productId: 'prod-headphones',
    ...
    console.log('- 11 Order Items including bundle components');
