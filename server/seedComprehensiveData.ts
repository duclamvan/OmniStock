...
const comprehensiveExpenses = [
  {
    id: nanoid(),
    type: "rent" as const,
    description: "Prague Main Warehouse - Monthly Rent February 2025",
    amount: "45000.00",
    currency: "CZK" as const,
    category: "facility",
    vendor: "Prague Properties s.r.o.",
    paymentMethod: "bank_transfer",
    receiptUrl: null,
    notes: "Monthly warehouse rent - 1,500 sqm facility",
  ...
  },
  {
    ...
    description: "Staff Salaries - February 2025",
    amount: "285000.00",
    currency: "CZK" as const,
    category: "personnel",
    ...
    paymentMethod: "bank_transfer",
    receiptUrl: null,
    notes: "Monthly salaries for 12 full-time employees",
  ...
  },
  {
    ...
    description: "Electricity & Utilities - All Warehouses",
    amount: "1250.00",
    currency: "EUR" as const,
    category: "utility",
    vendor: "ČEZ Group",
    ...
    receiptUrl: null,
    notes: "Electricity, heating, water for all warehouse locations",
  ...
  },
  {
    ...
    description: "DHL Express - Bulk Shipping Contract",
    amount: "3200.00",
    currency: "EUR" as const,
    category: "shipping",
    vendor: "DHL Express",
    ...
    receiptUrl: null,
    notes: "Monthly shipping contract for European deliveries",
  ...
  },
  {
    ...
    description: "WMS Software License - Enterprise Plan",
    amount: "850.00",
    currency: "EUR" as const,
    category: "software",
    vendor: "WMS Solutions Ltd",
    paymentMethod: "corporate_card",
    receiptUrl: null,
    notes: "Annual warehouse management system license",
    createdAt: new Date("2025-02-04T13:00:00Z"),
    updatedAt: new Date("2025-02-04T13:00:00Z"),
  },
];
