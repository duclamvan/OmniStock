...
export const COMMON_CARRIERS: Track17Carrier[] = [
  ...
  { key: 190001, name: "DHL Express", country: "INT", aliases: ["dhl", "dhl express"] },
  { key: 7041, name: "DHL Paket", country: "DE", aliases: ["dhl paket", "dhl germany", "dhl de"] },
  { key: 7047, name: "DHL eCommerce US", country: "US", aliases: ["dhl ecommerce", "dhl ecommerce us"] },
  { key: 7048, name: "DHL eCommerce Asia", country: "CN", aliases: ["dhl ecommerce asia"] },
  { key: 190002, name: "FedEx", country: "INT", aliases: ["fedex", "federal express"] },
  { key: 190003, name: "UPS", country: "INT", aliases: ["ups", "united parcel service"] },
  ...
  { key: 100003, name: "ZTO Express", country: "CN", aliases: ["zto", "zto express", "中通"] },
  { key: 100004, name: "STO Express", country: "CN", aliases: ["sto", "sto express", "申通"] },
  { key: 100005, name: "Yunda Express", country: "CN", aliases: ["yunda", "yunda express", "韵达"] },
  ...
  { key: 190046, name: "GLS", country: "INT", aliases: ["gls", "general logistics systems"] },
  { key: 190013, name: "DPD", country: "INT", aliases: ["dpd", "dynamic parcel distribution"] },
  { key: 190010, name: "TNT", country: "INT", aliases: ["tnt", "tnt express"] },
