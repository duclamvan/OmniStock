const reports = {
  ...
  dashboardSummary: 'Tổng quan bảng điều khiển',
  dashboardSummaryDesc: 'Tổng quan thời gian thực về tình trạng tồn kho và các chỉ số chính',
  totalProducts: 'Tổng sản phẩm',
  totalUnits: 'Tổng đơn vị',
  inventoryValue: 'Giá trị tồn kho',
  healthyStock: 'Hàng đủ',
  overstocked: 'Tồn dư',
  slowMoving: 'Luân chuyển chậm',
  incomingShipments: 'Hàng đang về',
  stockDistributionAnalytics: 'Phân tích phân phối tồn kho',
  stockDistributionAnalyticsDesc: 'Phân tích trực quan về tình trạng tồn kho và phân phối giá trị',
  stockHealthDistribution: 'Phân phối tình trạng tồn kho',
  stockValueByCategory: 'Giá trị tồn kho theo danh mục',
  stockMovementTrends: 'Xu hướng luân chuyển kho',
  stockMovementTrendsDesc: 'Theo dõi các lần thêm, bớt và điều chỉnh kho theo thời gian',
  movementType: 'Loại luân chuyển',
  allTypes: 'Tất cả loại',
  allSources: 'Tất cả nguồn',
  additions: 'Thêm vào',
  removals: 'Lấy ra',
  adjustments: 'Điều chỉnh',
  strategicReorderingInsights: 'Thông tin đặt hàng chiến lược',
  strategicReorderingDesc: 'Sản phẩm cần chú ý dựa trên mức tồn kho và xu hướng nhu cầu',
  daysOfCover: 'Số ngày có hàng',
  avgDailyDemand: 'Nhu cầu TB/ngày',
  reorderPriority: 'Ưu tiên đặt hàng',
  ...
  createPO: 'Tạo PO',
  noReorderRequired: 'Không có sản phẩm nào cần đặt hàng lại lúc này',
  fastMovingProducts: 'Sản phẩm bán chạy',
  fastMovingProductsDesc: 'Sản phẩm hoạt động tốt nhất theo đơn vị bán trong kỳ được chọn',
  unitsSoldLabel: 'Đã bán',
  velocity: 'Tốc độ',
  noFastMovingProducts: 'Không có dữ liệu sản phẩm bán chạy',
  noLowStockItems: 'Không tìm thấy hàng sắp hết',
  estimatedStockoutDays: 'Dự kiến hết hàng',
  ...
  urgency: 'Mức độ khẩn',
  sending: 'Đang gửi...',
  sendEmailAlert: 'Gửi cảnh báo Email',
  noDeadStockFound: 'Không tìm thấy hàng tồn ế',
  reorderAlerts: 'Cảnh báo đặt hàng',
  reorderAlertsDesc: 'Sản phẩm cần đặt hàng lại dựa trên mức tồn kho tối thiểu',
  noReorderAlerts: 'Không có cảnh báo đặt hàng',
  colorTrendTracking: 'Theo dõi xu hướng màu sắc',
  colorTrendDesc: 'Phân tích hiệu suất bán hàng theo biến thể màu cho danh mục Gel Polish',
  colorVariant: 'Biến thể màu',
  topSeller: 'Bán chạy nhất',
  popular: 'Phổ biến',
  noColorTrendData: 'Không có dữ liệu xu hướng màu sắc',
  deadStockReport: 'Báo cáo hàng tồn ế',
  deadStockDesc: 'Sản phẩm không có doanh số trong số ngày được chỉ định',
  daysThreshold: 'Ngưỡng ngày',
  daysSinceLastSale: 'Ngày từ lần bán cuối',
  productName: 'Tên sản phẩm',
  highestValueInventory: 'Tồn kho giá trị cao nhất',
  unitPrice: 'Đơn giá',
  reorderRate: 'Tỷ lệ đặt lại',
  
  // Business Report / Business Intelligence
  businessReport: 'Báo cáo kinh doanh',
  businessReportDesc: 'Phân tích kinh doanh AI để tối ưu dòng tiền và quản lý lợi nhuận',
  generateNewReport: 'Tạo báo cáo mới',
  generatingBusinessReport: 'Đang tạo báo cáo kinh doanh với phân tích AI...',
  latestAnalysis: 'Phân tích mới nhất',
  cashFlowHealth: 'Sức khỏe dòng tiền',
  urgentActions: 'Hành động khẩn cấp',
  aiRecommendations: 'Khuyến nghị AI',
  cashCollected: 'Tiền đã thu',
  netCashFlowLabel: 'Dòng tiền ròng',
  inventoryHealth: 'Sức khỏe tồn kho',
  lowStockAlertsCount: 'Cảnh báo hàng sắp hết',
  deadStockValue: 'Giá trị hàng tồn ế',
  daysUntilEmpty: 'Ngày đến hết hàng',
  reorderNow: 'Đặt hàng ngay',
  liquidate: 'Thanh lý',
  profitOptimization: 'Tối ưu lợi nhuận',
  ...
  failedToGenerateReport: 'Không thể tạo báo cáo kinh doanh',
  noBusinessReportYet: 'Chưa có báo cáo kinh doanh',
  generateFirstReport: 'Tạo báo cáo kinh doanh đầu tiên để nhận thông tin AI về dòng tiền, sức khỏe tồn kho và cơ hội tối ưu lợi nhuận.',
  lastGenerated: 'Tạo lần cuối',
  viewFullReport: 'Xem báo cáo đầy đủ',
  aiPoweredInsights: 'Thông tin AI',
  cashFlowSummary: 'Tóm tắt dòng tiền',
  topSellers: 'Bán chạy nhất',
  reorderUrgent: 'Đặt hàng khẩn',
