const inventory = {
  ...
  warehouseLabel: 'Nhãn kho hàng',
  warehouseLabelDesc: 'Xem trước và in nhãn kệ cho máy in nhiệt (100mm × 30mm)',
  printLabel: 'In nhãn',
  labelDimensions: 'Kích thước',
  ...
  printAllLabels: 'In tất cả nhãn',
  generatingLabels: 'Đang tạo...',
  labelsPrinted: 'Đã in {{count}} nhãn thành công',
  allLabelsGenerated: 'Đã tạo nhãn cho {{count}} sản phẩm',
  generateLabelsError: 'Không thể tạo nhãn',
  ...
  bundleName: 'Tên gói',
  bundleNameEn: 'Tên tiếng Anh',
  bundleNameEnPlaceholder: 'vd: Big Carton Pack',
  bundleNameVi: 'Tên tiếng Việt',
  bundleNameViPlaceholder: 'vd: Gói Thùng Lớn',
  ...
  healthy: 'Ổn định',
  lowStockShort: 'Tồn thấp',
  outOfStockShort: 'Hết hàng',
  overstockedShort: 'Tồn dư',
  slowMovingShort: 'Chậm tiêu',
  incoming: 'Đang về',
  next90Days: '90 ngày tới',
  next180Days: '180 ngày tới',
  nextYear: 'Năm tới',
  ...
  reorderSoon: 'Sắp đặt hàng',
  clearance: 'Thanh lý',
  slowMovers: 'Hàng chậm',
  suggest: 'Đề xuất',
  noUrgentReorders: 'Không có đơn hàng cần đặt gấp',
  noUpcomingReorders: 'Không có đơn hàng sắp cần đặt',
  noClearanceCandidates: 'Không có hàng cần thanh lý',
  ...
  noRunsInPeriod: 'Không có lần sản xuất trong khoảng thời gian này',
  runNumber: 'Lần #',
