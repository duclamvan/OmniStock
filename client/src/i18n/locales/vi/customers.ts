const customers = {
  ...
  facebookFetchFailed: 'Không thể tải hồ sơ Facebook',
  couldNotFetchFacebookProfile: 'Không thể lấy dữ liệu hồ sơ Facebook',
  noProfileDataFound: 'Không tìm thấy dữ liệu hồ sơ. Hồ sơ có thể riêng tư hoặc không khả dụng.',
  foundProfile: 'Đã tìm thấy hồ sơ của {{name}}',
  profileDataRetrieved: 'Đã lấy dữ liệu hồ sơ thành công',
