const system = {
  ...
  trackAllSystemActivitiesForThisUser: 'Theo dõi tất cả hoạt động hệ thống của người dùng này',
  noActivityRecorded: 'Chưa có hoạt động',
  noActivityRecordedYet: 'Chưa có hoạt động nào được ghi nhận cho người dùng này',
  activityDetails: 'Chi tiết hoạt động',
  viewDetailedInformation: 'Xem thông tin chi tiết về hoạt động này',
  viewActivityLog: 'Xem nhật ký hoạt động',
  ...
  last30Days: '30 ngày',
  incidents: 'Sự cố',
  incidentsDescription: 'Theo dõi và quản lý sự cố và vấn đề hiệu suất của nhân viên',
  addIncident: 'Thêm Sự cố',
  editIncident: 'Sửa Sự cố',
  deleteIncident: 'Xóa Sự cố',
  incidentCreated: 'Đã tạo sự cố thành công',
  incidentUpdated: 'Đã cập nhật sự cố thành công',
  incidentDeleted: 'Đã xóa sự cố thành công',
  incidentStatusUpdated: 'Đã cập nhật trạng thái sự cố',
  deleteIncidentConfirmation: 'Bạn có chắc chắn muốn xóa sự cố này? Hành động này không thể hoàn tác.',
  noIncidents: 'Không có sự cố nào được ghi nhận cho nhân viên này',
  addIncidentDescription: 'Ghi nhận sự cố mới cho nhân viên này',
  editIncidentDescription: 'Cập nhật chi tiết sự cố',
  incidentTitlePlaceholder: 'Mô tả ngắn gọn về sự cố',
  incidentDescriptionPlaceholder: 'Cung cấp mô tả chi tiết về những gì đã xảy ra...',
  incidentNotesPlaceholder: 'Thêm ghi chú hoặc hành động tiếp theo...',
  selectType: 'Chọn loại',
  selectSeverity: 'Chọn mức độ',
  mistake: 'Lỗi',
  safety: 'An toàn',
  quality: 'Chất lượng',
  ...
  tasks: 'Công việc',
  tasksDescription: 'Công việc kho được giao cho nhân viên này',
  noTasks: 'Không có công việc nào được giao cho nhân viên này',
  completedAt: 'Hoàn thành lúc',
  activityDescription: 'Hoạt động hệ thống gần đây của nhân viên này',
  employeeNotFound: 'Không Tìm thấy Nhân viên',
  employeeNotFoundDescription: 'Nhân viên bạn đang tìm kiếm không tồn tại hoặc đã bị xóa.',
  notes: 'Ghi chú',
  title: 'Tiêu đề',
  type: 'Loại',
  severity: 'Mức độ',
