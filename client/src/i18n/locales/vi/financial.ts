const financial = {
  ...
  downloadPDF: 'Tải PDF',
  receiptDownloaded: 'Tải hóa đơn PDF thành công',
  receiptDownloadFailed: 'Tải hóa đơn PDF thất bại',
  confirm: 'Xác nhận',
  items: 'Sản phẩm',
  time: 'Thời gian',
  
  // POS UI
  posTitle: 'Điểm Bán Hàng',
  posSystem: 'Hệ thống POS Davie Supply',
  warehouse: 'Kho',
  searchOrScan: 'Tìm kiếm hoặc quét mã vạch...',
  customItem: 'Tùy chỉnh',
  inCart: 'trong giỏ',
  noProductsFound: 'Không tìm thấy sản phẩm',
  tryAdjustingSearch: 'Thử điều chỉnh tìm kiếm hoặc bộ lọc danh mục',
  cartIsEmptyMessage: 'Giỏ hàng trống',
  scanOrClickToAdd: 'Quét hoặc nhấn sản phẩm để thêm',
  editNotes: 'Sửa ghi chú',
  addNotes: 'Thêm ghi chú',
  processing: 'Đang xử lý...',
  payAmount: 'Thanh toán {{amount}}',
  pressToSelectMethod: 'Nhấn 1-6 để chọn phương thức',
  card: 'Thẻ',
  comingSoon: '(Sắp có)',
  privatKonto: 'Tài khoản cá nhân',
  invoiceTransfer: 'Chuyển khoản hóa đơn',
  insufficientAmount: 'Số tiền không đủ',
  insufficientAmountDesc: 'Tiền nhận ({{received}}) ít hơn tổng ({{total}})',
  invalidDiscount: 'Giảm giá không hợp lệ',
  percentageCannotExceed100: 'Phần trăm không thể lớn hơn 100%',
  discountCannotExceedSubtotal: 'Giảm giá không thể lớn hơn tạm tính',
  cashPayment: 'Thanh toán tiền mặt',
  enterAmountReceived: 'Nhập số tiền nhận từ khách',
  customerPays: 'Khách trả',
  exact: 'Đúng số',
  changeToGive: 'Tiền thối',
  stillOwed: 'Còn thiếu',
  needMoreMoney: 'Cần thêm tiền!',
  selectCustomer: 'Chọn khách hàng',
  searchCustomerHint: 'Tìm theo tên, Facebook, điện thoại, email, thành phố hoặc quốc gia',
  searchCustomerPlaceholder: 'Tìm khách hàng...',
  walkInCustomer: 'Khách vãng lai',
  walkInCustomerTapToSelect: 'Khách vãng lai (nhấn để chọn)',
  noCustomerRecord: 'Không có hồ sơ khách hàng',
  customer: 'Khách hàng',
  selectCustomerForPayLater: 'Chọn khách hàng để trả sau',
  searchPayLaterHint: 'Tìm theo tên, tên Facebook, email, điện thoại hoặc công ty',
  backToPaymentOptions: 'Quay lại phương thức thanh toán',
  amountInCzk: 'Số tiền bằng CZK',
  item: 'sản phẩm',
  orderNotes: 'Ghi chú đơn hàng',
  addOrderNotesPlaceholder: 'Thêm ghi chú cho đơn hàng... (Ctrl+Enter để lưu)',
  saveNotes: 'Lưu ghi chú',
  applyDiscount: 'Áp dụng giảm giá',
  percentage: 'Phần trăm',
  fixedAmount: 'Số tiền cố định',
  enterPercentagePlaceholder: 'Nhập phần trăm (vd: 10)',
  ...
  saleComplete: 'Bán hàng thành công!',
  close: 'Đóng',
  
  // Receipt EU Compliance - Multi-language
  receiptLanguage: 'Ngôn ngữ hóa đơn',
  companyId: 'Mã số doanh nghiệp',
  vatId: 'Mã số thuế',
  ...
  // ServiceDetails Page (unique keys only - duplicates removed)
  walkInCustomer: 'Khách vãng lai',
