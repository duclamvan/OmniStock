...
const common = {
  ...
  cashOutAll: 'Rút tất cả',
  cashOutNotesPlaceholder: 'Lý do rút tiền...',
  cashOutRecorded: 'Đã ghi nhận rút tiền {{amount}} thành công',
  availableBalance: 'Số dư khả dụng',
  totalSales: 'Tổng doanh thu',
  averageSale: 'Trung bình/đơn',
  transactions: 'giao dịch',
  salesHistory: 'Lịch sử bán hàng',
  searchSales: 'Tìm kiếm theo mã, khách hàng, hoặc ghi chú...',
  allPayments: 'Tất cả thanh toán',
  saleDetails: 'Chi tiết bán hàng',
  editSale: 'Sửa bán hàng',
  editSaleDescription: 'Cập nhật phương thức thanh toán hoặc ghi chú cho đơn này',
  deleteSale: 'Xóa bán hàng',
  deleteSaleConfirmation: 'Bạn có chắc muốn xóa đơn này? Hành động này không thể hoàn tác.',
  saleDeleted: 'Đã xóa đơn bán hàng thành công',
  saleUpdated: 'Đã cập nhật đơn bán hàng thành công',
  qrPayment: 'Thanh toán QR',
  invalidAmount: 'Vui lòng nhập số tiền hợp lệ',
  insufficientCash: 'Số tiền vượt quá số dư tiền mặt',
  ...
  locationMarkedForDeletion: 'Vị trí đã được đánh dấu để xóa',
  undoAvailable: 'Bạn có {{seconds}} giây để hoàn tác',
  deletingLocation: 'Đang xóa vị trí {{location}}',
  undoCountdown: 'Còn {{seconds}}s để hoàn tác',
  deletionCancelled: 'Đã hủy xóa',
  locationRestored: 'Vị trí đã được khôi phục',
  ...
  performance: {
    ...
    trackPerformance: 'Theo dõi hiệu suất nhân viên và cạnh tranh vị trí đầu bảng',
    rankings: 'Xếp hạng',
    ...
    badgeEarnedAt: 'Nhận được {{date}}',
    totalPoints: 'Tổng điểm',
    currentLevel: 'Cấp độ hiện tại',
    xpProgress: 'Tiến độ XP',
    xpToNextLevel: '{{current}} / {{total}} XP để lên cấp',
    recentBadges: 'Huy hiệu gần đây',
    noDataYet: 'Chưa có dữ liệu hiệu suất',
    startPicking: 'Bắt đầu lấy hàng và đóng gói để kiếm điểm!',
    you: 'Bạn',
    noRankings: 'Chưa có xếp hạng',
    beFirst: 'Hãy là người đầu tiên kiếm điểm!',
    // Badge names
    badgeFirstPick: 'Lần lấy đầu tiên',
    badgePicker10: 'Lấy 10 đơn',
    badgePicker50: 'Lấy 50 đơn',
    badgePicker100: 'Lấy 100 đơn',
    badgePacker10: 'Đóng 10 đơn',
    badgePacker50: 'Đóng 50 đơn',
    badgePacker100: 'Đóng 100 đơn',
    badgeSpeedDemon: 'Tốc độ nhanh',
    badgeStreak5: 'Chuỗi 5 ngày',
    badgeStreak10: 'Chuỗi 10 ngày',
    badgeLevel5: 'Cấp độ 5',
    badgeLevel10: 'Cấp độ 10',
  },
