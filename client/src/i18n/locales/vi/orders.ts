const orders = {
  ...
  capturePreview: 'Xem trước',
  capturePreviewDesc: 'Kiểm tra hóa đơn trước khi tải xuống',
  downloadImage: 'Tải ảnh',
  captureError: 'Lỗi chụp',
  captureErrorDesc: 'Không thể chụp ảnh đơn hàng',
  ...
  customerPriceApplied: 'Đã áp dụng giá khách hàng',
  customerPriceAppliedDesc: 'Đã áp dụng giá tùy chỉnh {{price}} {{currency}}',
  customerPricesAppliedCount: 'Đã áp dụng giá tùy chỉnh cho {{count}} sản phẩm',
  ...
  merchandiseTotal: 'Tổng hàng hóa',
  promotionalSavings: 'Tiết kiệm khuyến mãi',
  subtotal: 'Tạm tính',
  discount: 'Giảm giá',
  ...
  changePayment: 'Thay đổi thanh toán',
