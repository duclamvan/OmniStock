const orders = {
  ...
  importOrdersDescription: 'Tải lên file Excel để nhập đơn hàng hàng loạt. Sử dụng mẫu để đảm bảo định dạng chính xác.',
  downloadTemplateFirst: 'Tải mẫu trước',
  templateDescription: 'Sử dụng mẫu này để đảm bảo dữ liệu được định dạng chính xác cho việc nhập.',
  downloadTemplate: 'Tải mẫu',
  selectFile: 'Chọn file Excel',
  importTemplate: 'Mẫu nhập đơn hàng',
  templateDownloaded: 'Tải mẫu thành công',
  invalidFileType: 'Vui lòng chọn file Excel hợp lệ (.xlsx hoặc .xls)',
  ...
  startDate: 'Bắt đầu',
  endDate: 'Kết thúc',
  searchPlaceholderExtended: 'Tìm theo đơn hàng, khách, mã vận đơn, ghi chú...',
  ...
  // Form field validation - human readable messages
  fieldError_customerId: 'Khách hàng',
  fieldError_customerId_required: 'Vui lòng chọn khách hàng cho đơn hàng này',
  fieldError_grandTotal: 'Tổng cộng',
  fieldError_grandTotal_required: 'Tổng đơn hàng là bắt buộc',
  fieldError_grandTotal_invalid: 'Vui lòng nhập số tiền tổng hợp lệ',
  fieldError_currency: 'Tiền tệ',
  fieldError_currency_required: 'Vui lòng chọn loại tiền tệ',
  fieldError_shippingMethod: 'Phương thức vận chuyển',
  fieldError_shippingMethod_required: 'Vui lòng chọn phương thức vận chuyển',
  fieldError_paymentMethod: 'Phương thức thanh toán',
  fieldError_paymentMethod_required: 'Vui lòng chọn phương thức thanh toán',
  fieldError_orderStatus: 'Trạng thái đơn hàng',
  fieldError_orderStatus_required: 'Vui lòng chọn trạng thái đơn hàng',
  fieldError_paymentStatus: 'Trạng thái thanh toán',
  fieldError_paymentStatus_required: 'Vui lòng chọn trạng thái thanh toán',
  fieldError_priority: 'Mức độ ưu tiên',
  fieldError_priority_required: 'Vui lòng chọn mức độ ưu tiên',
  fieldError_shippingAddressId: 'Địa chỉ giao hàng',
  fieldError_shippingAddressId_required: 'Vui lòng chọn hoặc thêm địa chỉ giao hàng',
  fieldError_notes: 'Ghi chú',
  fieldError_notes_invalid: 'Vui lòng nhập ghi chú hợp lệ',
  fieldError_shippingCost: 'Phí vận chuyển',
  fieldError_shippingCost_invalid: 'Vui lòng nhập phí vận chuyển hợp lệ',
  fieldError_discountValue: 'Giảm giá',
  fieldError_discountValue_invalid: 'Vui lòng nhập số tiền giảm giá hợp lệ',
  fieldError_taxRate: 'Thuế suất',
  fieldError_taxRate_invalid: 'Vui lòng nhập thuế suất hợp lệ',
  fieldError_codAmount: 'Tiền thu hộ',
  fieldError_codAmount_invalid: 'Vui lòng nhập số tiền thu hộ hợp lệ',
  fieldError_adjustment: 'Điều chỉnh',
  fieldError_adjustment_invalid: 'Vui lòng nhập số tiền điều chỉnh hợp lệ',
  fieldError_required: 'Trường này là bắt buộc',
  fieldError_invalid: 'Vui lòng nhập giá trị hợp lệ',
  creating: 'Đang tạo...',
  saveDraft: 'Lưu nháp',
  ...
  reminderTiming: 'Thời điểm thông báo',
  reminderTimingHint: 'Chọn thời điểm gửi nhắc nhở so với ngày hàng về',
  daysBefore_one: '{{count}} ngày trước',
  daysBefore_other: '{{count}} ngày trước',
  sameDay: 'Cùng ngày',
  daysAfter_one: '{{count}} ngày sau',
  daysAfter_other: '{{count}} ngày sau',
  ...
  copyTrackingUrl: 'Sao chép URL theo dõi',
  openTrackingPage: 'Mở trang theo dõi',
  trackingUrlCopied: 'Đã Sao chép URL Theo dõi',
  trackingUrlCopiedDesc: 'URL theo dõi đã được sao chép vào clipboard',
  trackingNumberCopied: 'Đã Sao chép Mã Theo dõi',
  ...
  // Bank Import
  bankImport: 'Nhập ngân hàng',
  bankImportDescription: 'Nhập giao dịch ngân hàng để tự động khớp và đánh dấu đơn hàng đã thanh toán',
  uploadCSV: 'Tải lên CSV',
  uploadCSVDescription: 'Tải lên file xuất giao dịch ngân hàng (định dạng CSV với dấu phẩy chấm)',
  dragDropCSV: 'Kéo thả file CSV vào đây',
  orClickToUpload: 'hoặc nhấp để chọn file',
  rowsParsed: 'dòng đã phân tích',
  preview: 'Xem trước',
  matchingSettings: 'Cài đặt khớp',
  enableFuzzyMatching: 'Bật khớp mờ',
  fuzzyMatchingDescription: 'Khớp thanh toán không có mã đơn theo số tiền (±2.00) và ngày (±30 ngày)',
  amountTolerance: 'Sai lệch cho phép',
  amountToleranceDescription: 'Chênh lệch tối đa cho phép (bằng đơn vị tiền tệ)',
  matching: 'Đang khớp...',
  importAndMatch: 'Nhập & Khớp',
  matchingResults: 'Kết quả khớp',
  autoMatched: 'Tự động khớp',
  needsReview: 'Cần xem xét',
  unmatched: 'Không khớp',
  noAutoMatches: 'Không tìm thấy khớp tự động',
  noReviewItems: 'Không có mục cần xem xét thủ công',
  allPaymentsMatched: 'Tất cả thanh toán đã được khớp!',
  paymentDate: 'Ngày thanh toán',
  payee: 'Người gửi',
  matchType: 'Loại khớp',
  exact: 'Chính xác',
  fuzzy: 'Mờ',
  matchDifference: 'Chênh lệch',
  account: 'Tài khoản',
  possibleMatches: 'khớp có thể',
  selectedOrder: 'Đơn hàng đã chọn',
  selectOrder: 'Chọn đơn hàng',
  selectAnOrder: 'Chọn đơn hàng...',
  confirmSelected: 'Xác nhận đã chọn',
  confirmPairing: 'Xác nhận ghép',
  confirming: 'Đang xác nhận...',
  reason: 'Lý do',
  findOrder: 'Tìm đơn',
  bankImportComplete: 'Nhập hoàn tất',
  bankImportResults: 'Tìm thấy {{matched}} tự động khớp, {{review}} cần xem xét, {{unmatched}} không khớp',
  paymentsConfirmed: 'Đã xác nhận thanh toán',
  paymentsConfirmedDesc: 'Đã cập nhật {{count}} đơn hàng thành đã thanh toán',
