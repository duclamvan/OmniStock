const settings = {
  ...
  pplCzPackageLimitsDescription: 'Trọng lượng và kích thước gói hàng tối đa cho PPL Czech Republic (tối đa 50kg, 200×80×60cm)',
  maximumWeightKg: 'Trọng lượng tối đa (kg)',
  pplMaxWeightDescription: 'PPL tối đa: 50kg',
  maximumDimensionsCm: 'Kích thước tối đa (cm)',
  pplMaxDimensionsDescription: 'D×R×C (PPL tối đa: 200×80×60)',
