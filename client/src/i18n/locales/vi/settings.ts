const settings = {
  ...
  orderDefaultsTitle: 'Cài đặt đơn hàng mặc định',
  ...
  pplPackageType: 'Loại gói PPL',
  pplPackageTypeDescription: 'Chọn loại dịch vụ PPL mặc định cho nhãn vận chuyển',
  pplPrivate: 'PPL PARCEL CZ PRIVATE',
  pplPrivateDescription: 'Cho địa chỉ cá nhân (khách hàng e-shop)',
  pplBusiness: 'PPL PARCEL CZ BUSINESS',
  pplBusinessDescription: 'Cho địa chỉ doanh nghiệp (B2B)',
  pplSmart: 'PPL PARCEL CZ SMART',
  pplSmartDescription: 'Cho giao hàng ParcelShop/ParcelBox',
  pplTieredPricing: 'Bảng giá PPL CZ theo trọng lượng (CZK)',
  pplTieredPricingNote: 'Giá cố định theo mức trọng lượng - giá được đặt theo hợp đồng PPL',
  upToWeight: 'đến {{weight}} kg',
  pplMaxWeightDescription: 'Giới hạn trọng lượng tối đa cho gói PPL (đến 31.5kg)',
  pplMaxDimensionsDescription: 'Kích thước tối đa 120×60×60 cm, chu vi+chiều dài tối đa 360 cm',
  pplSurcharges: 'Phụ phí bổ sung',
  ...
  insuranceSettings: 'Cài đặt bảo hiểm',
  insurancePercent: 'Tỷ lệ bảo hiểm',
  ofDeclaredValue: '% giá trị khai báo',
  minimumInsuranceFee: 'Phí tối thiểu',
  insuranceDescription: 'Phí bảo hiểm dựa trên giá trị lô hàng khai báo (lấy giá trị cao hơn giữa phần trăm hoặc phí tối thiểu)',
  ...
  userManagementAndRoleAssignment: 'Quản lý người dùng và phân quyền',
  systemSettingsConfiguration: 'Cấu hình cài đặt hệ thống',
  financialDataAccess: 'Truy cập dữ liệu tài chính',
  allWarehouseOperations: 'Tất cả hoạt động kho hàng',
  orderManagementAndFulfillment: 'Quản lý và xử lý đơn hàng',
  inventoryAndStockManagement: 'Quản lý tồn kho và hàng hóa',
  limitedFinancialDataVisibility: 'Hạn chế xem dữ liệu tài chính',
  noUserOrSystemManagementAccess: 'Không có quyền quản lý người dùng hoặc hệ thống',
  ...
  assignUsers: 'Phân quyền người dùng',
  
  // Roles Management - Role List
  rolesList: 'Danh sách vai trò',
  rolesListDescription: 'Cấu hình vai trò hệ thống và tùy chỉnh với quyền hạn',
  addRole: 'Thêm vai trò',
  editRole: 'Sửa vai trò',
  deleteRole: 'Xóa vai trò',
  roleName: 'Tên vai trò',
  roleSlug: 'Mã vai trò',
  roleSlugDescription: 'Mã định danh duy nhất (chữ thường, không dấu cách)',
  displayName: 'Tên hiển thị',
  displayNameVi: 'Tên hiển thị (Tiếng Việt)',
  roleDescription: 'Mô tả',
  roleDescriptionVi: 'Mô tả (Tiếng Việt)',
  roleColor: 'Màu sắc',
  roleIcon: 'Biểu tượng',
  roleType: 'Loại',
  systemRole: 'Hệ thống',
  ...
  cannotModifySystemRoleName: 'Không thể thay đổi tên vai trò hệ thống',
  roleCreatedSuccessfully: 'Tạo vai trò thành công',
  roleUpdatedSuccessfully: 'Cập nhật vai trò thành công',
  roleDeletedSuccessfully: 'Xóa vai trò thành công',
  failedToCreateRole: 'Tạo vai trò thất bại',
  failedToUpdateRole: 'Cập nhật vai trò thất bại',
  failedToDeleteRole: 'Xóa vai trò thất bại',
  deleteRoleConfirmation: 'Bạn có chắc chắn muốn xóa vai trò này?',
  deleteRoleWarning: 'Hành động này không thể hoàn tác. Người dùng được gán vai trò này sẽ cần được gán lại.',
  roleHasUsers: 'Không thể xóa vai trò. {{count}} người dùng được gán vai trò này.',
  
  // Roles Management - Permissions
  permissionsSection: 'Quyền hạn',
  selectPermissions: 'Chọn quyền hạn',
  noPermissionsSelected: 'Chưa chọn quyền hạn',
  selectAllSection: 'Chọn tất cả',
  deselectAllSection: 'Bỏ chọn tất cả',
  permissionSection: 'Phần',
  permissionPages: 'Trang',
  ...
  sectionWarehouses: 'Các kho hàng',
  sectionWarehouseDashboard: 'Bảng điều khiển kho',
  sectionCustomers: 'Khách hàng',
  sectionSuppliers: 'Nhà cung cấp',
  ...
  sectionPacking: 'Vật liệu đóng gói',
  sectionPickpack: 'Chọn & Đóng gói',
  ...
  sectionDiscounts: 'Giảm giá',
  sectionExpenses: 'Chi phí',
  sectionReceiving: 'Nhận hàng',
  ...
  roleFormTitle: 'Chi tiết vai trò',
  roleFormDescription: 'Cấu hình tên, giao diện và quyền hạn của vai trò',
  ...
  pplCzPackageLimitsDescription: 'Trọng lượng và kích thước gói hàng tối đa cho PPL Czech Republic (tối đa 31.5kg, 120×60×60cm)',
  maximumWeightKg: 'Trọng lượng tối đa (kg)',
  maximumDimensionsCm: 'Kích thước tối đa (cm)',
  pplShippingRatesTitle: 'Bảng giá vận chuyển PPL',
  pplShippingRatesDescription: 'Cấu hình giá cố định mỗi kg cho từng quốc gia + phí COD (dobírka)',
  countryShippingRatesCzk: 'Giá vận chuyển theo quốc gia (CZK)',
  addCountry: '+ Thêm quốc gia',
  baseLabel: 'Cơ bản:',
  perKgLabel: '+ mỗi kg:',
  czkPerKg: 'CZK/kg',
  noCountriesConfigured: 'Chưa cấu hình quốc gia nào. Thêm quốc gia để đặt giá.',
  dobirkaCodFees: 'Phí Dobírka (COD)',
  cashPayment: 'Thanh toán tiền mặt',
  cardPayment: 'Thanh toán thẻ',
  codFeesDescription: 'Phí này được thêm khi phương thức thanh toán đơn hàng là COD (dobírka)',

  // Country names
  countryCzechRepublic: 'Cộng hòa Séc',
  countrySlovakia: 'Slovakia',
  countryPoland: 'Ba Lan',
  countryAustria: 'Áo',
  countryGermany: 'Đức',
  countryHungary: 'Hungary',
  countryNetherlands: 'Hà Lan',
  countryBelgium: 'Bỉ',
  countryFrance: 'Pháp',
  countryItaly: 'Ý',
  countrySpain: 'Tây Ban Nha',
  countryPortugal: 'Bồ Đào Nha',
  countryUnitedKingdom: 'Vương quốc Anh',
  countrySwitzerland: 'Thụy Sĩ',
  ...
  glsDePackageLimitsRatesTitle: 'Giới hạn & Bảng giá gói hàng GLS DE',
  glsDePackageLimitsRatesDescription: 'Ràng buộc gói hàng và bảng giá vận chuyển cho GLS Đức',
  packageLimits: 'Giới hạn gói hàng',
  glsMaxWeightDescription: 'GLS tối đa: 40kg',
  maximumGirthLongestSide: 'Chu vi tối đa + Cạnh dài nhất (cm)',
  glsMaxGirthDescription: 'Chu vi (2×R + 2×C) + cạnh dài nhất (GLS tối đa: 300cm)',
  shippingRatesEur: 'Bảng giá vận chuyển (EUR)',
  paketXS: 'Gói XS',
  paketS: 'Gói S',
  paketM: 'Gói M',
  paketL: 'Gói L',
  ...
  dhlDePackageRatesLimitsTitle: 'Bảng giá & Giới hạn gói hàng DHL DE',
  dhlDePackageRatesLimitsDescription: 'Kích thước gói hàng với giới hạn trọng lượng, kích thước và giá cho DHL Đức',
  paket2kg: 'Gói 2kg',
  paket5kg: 'Gói 5kg',
  paket10kg: 'Gói 10kg',
  paket20kg: 'Gói 20kg',
  paket31kg: 'Gói 31kg',
  maxWeightKg: 'Trọng lượng tối đa (kg)',
  ...
  defaultCarrierForCountry: 'Đơn vị vận chuyển mặc định theo quốc gia',
  defaultCarrierForCountryDescription: 'Ánh xạ quốc gia với đơn vị vận chuyển mặc định. Khi thêm đơn hàng mới, đơn vị vận chuyển sẽ được tự động chọn dựa trên quốc gia của khách hàng.',
  ...
  shippingCostsDescription: 'Cấu hình chi phí vận chuyển mặc định và ngưỡng miễn phí',
  defaultShippingCostEur: 'Chi phí vận chuyển mặc định (EUR)',
  defaultCostEurDescription: 'Chi phí mặc định cho đơn hàng EUR',
  freeShippingThresholdEur: 'Ngưỡng miễn phí vận chuyển (EUR)',
  freeShippingEurDescription: 'Giá trị đơn hàng để miễn phí vận chuyển bằng EUR',
  defaultShippingCostCzk: 'Chi phí vận chuyển mặc định (CZK)',
  defaultCostCzkDescription: 'Chi phí mặc định cho đơn hàng CZK',
  ...
  labelGenerationDescription: 'Cấu hình tùy chọn và định dạng nhãn vận chuyển',
