const warehouse = {
  ...
  codeAutoGenerated: 'Tự động tạo. Đây sẽ là ID của kho.',
  ...
  addMultipleCartonsAtOnce: 'Thêm nhanh nhiều thùng carton từ cùng một nhà cung cấp',
  supplierForAllCartons: 'Thông tin nhà cung cấp',
  supplierUrl: 'Đường dẫn nhà cung cấp',
  supplierUrlDescription: 'Link đến trang sản phẩm (tùy chọn)',
  costCurrency: 'Đơn vị tiền tệ',
  cartonEntries: 'Danh sách thùng carton',
  addRow: 'Thêm hàng',
  addEmptyRow: 'Thêm hàng trống',
  removeRow: 'Xóa',
  ...
  addAtLeastOneCarton: 'Vui lòng thêm ít nhất một thùng carton có kích thước',
  creatingCartons: 'Đang tạo thùng carton...',
  supplierUrlPlaceholder: 'https://nhacungcap.com/san-pham',
  cartonNamePlaceholder: 'vd: Thùng carton vận chuyển trung bình',
  presetSizes: 'Thêm nhanh',
  presetSizesDescription: 'Nhấn để thêm các kích thước thùng phổ biến',
  addPresetCarton: 'Thêm thùng có sẵn',
  dimensionsLxWxH: 'D × R × C',
  validCartons: 'Hợp lệ',
  ...
  createTaskDescription: 'Tạo công việc cho nhân viên kho',
