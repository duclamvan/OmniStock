...
const imports = {
  ...
  internalCarrierUrlOrName: 'Hãng vận chuyển (URL hoặc Tên)',
  trackingUrl: 'Link theo dõi',
  enterInternalTracking: 'Nhập mã vận đơn nội bộ',
  enterInternalCarrier: 'Nhập hãng vận chuyển nội bộ',
  enterInternalCarrierUrlOrName: 'VD: https://tracking.com hoặc Tên hãng',
  ...
  movedToInternationalTransit: 'Đã chuyển sang Vận chuyển quốc tế',
  youCanAddTrackingLater: 'Bạn có thể thêm thông tin theo dõi sau từ Vận chuyển quốc tế',
  viewPendingShipments: 'Xem lô hàng chờ',
  enterShipmentDetails: 'Nhập thông tin lô hàng',
  carrierPlaceholder: 'vd: DHL, FedEx, UPS',
  trackingNumberPlaceholder: 'Nhập mã vận đơn',
  originPlaceholder: 'vd: Trung Quốc',
  ...
  daysOverdue: 'ngày trễ',
  weekRemaining: 'tuần còn lại',
  weeksRemaining: 'tuần còn lại',
  monthRemaining: 'tháng còn lại',
  monthsRemaining: 'tháng còn lại',
  selectEtaDate: 'Chọn ngày giao dự kiến',
  incoming: 'Đang đến',
  fillLater: 'Điền sau',
  createShipment: 'Tạo lô hàng',
  creating: 'Đang tạo...',
  shipmentCreatedSuccessfully: 'Đã tạo lô hàng thành công',
  shipmentCreationFailed: 'Không thể tạo lô hàng',
  carrierAndTrackingRequired: 'Cần có hãng vận chuyển và mã vận đơn',
  ...
  confirmDeleteSelected: 'Bạn có chắc chắn muốn xóa {{count}} sản phẩm đã chọn? Thao tác này không thể hoàn tác.',
  ...
  totalCostPerUnit: 'Tổng chi phí/đơn vị',
  totalCostEUR: 'Tổng chi phí (EUR)',
  totalCostCZK: 'Tổng chi phí (CZK)',
  productCost: 'Chi phí sản phẩm',
  grandTotal: 'Tổng cộng',
  grandTotalCZK: 'Tổng cộng (CZK)',
  serverCalculated: 'Server tính toán',
  estimated: 'Ước tính',
  landingCostsFromServer: 'Chi phí nhập được tính bởi server với tổng hợp chi phí đầy đủ.',
  landingCostsEstimated: 'Chi phí nhập là ước tính. Giá trị cuối cùng sẽ được tính khi nhận hàng.',
  totals: 'Tổng cộng',
  ...
  avgLandedCostApplied: 'Đã áp dụng giá vốn TB',
  ...
  noArchivedShipmentsDescription: 'Lô hàng lưu trữ sẽ xuất hiện ở đây sau khi lưu trữ hàng tuần.',
  archivedShipmentsStoredHere: 'Lô hàng lưu trữ được lưu ở đây để lưu giữ hồ sơ.',
  archivedShipments: 'Lô hàng đã lưu trữ',
  archiveWeek: 'Lưu trữ tuần',
  archiving: 'Đang lưu trữ...',
  weekLabel: 'Tuần',
  archivedOn: 'Lưu trữ lúc',
  shipmentsPlural: 'lô hàng',
  restore: 'Khôi phục',
  shipmentArchived: 'Đã lưu trữ lô hàng',
  shipmentArchivedSuccess: 'Tất cả lô hàng đang hoạt động đã được lưu trữ thành công.',
  shipmentUnarchived: 'Đã khôi phục lô hàng',
  ...
  tapToAssign: 'Chạm để gán tất cả',
  orEnterManually: 'Hoặc nhập vị trí thủ công',
  ...
  reset: 'Đặt lại',
  coreColumns: 'Cột chính',
  costColumns: 'Cột chi phí',
  detailedColumns: 'Cột chi tiết',
  // Column IDs (unique prefixed keys to avoid conflicts)
  colProduct: 'Sản phẩm',
  colUnits: 'Số lượng',
  colPurchPrice: 'Giá mua',
  colChgKg: 'Kg có thể tính phí',
  colFreight: 'Vận chuyển',
  colDuty: 'Thuế/Phí',
  colBrokerage: 'Phí môi giới hải quan',
  colInsurance: 'Bảo hiểm',
  colPackaging: 'Đóng gói',
  colOther: 'Khác',
  colLandingCost: 'Chi phí nhập/Đơn vị',
  ...
  purchaseOrderShipping: 'Phí vận chuyển đơn hàng',
  fromPurchaseOrders: 'Từ các đơn đặt hàng liên kết',
  includesPOShipping: 'Bao gồm phí vận chuyển PO',
  ...
  addProductWithVariants: 'Thêm sản phẩm với {{count}} biến thể',
  productWithVariantsAdded: '{{name}} đã được thêm với {{count}} biến thể',
  includedVariants: '{{count}} biến thể bao gồm',
  variants: 'biến thể',
  ...
  applyToAllCount: 'Áp dụng tất cả ({{count}})',
  ...
  // CostsPanel - Complete Cost Breakdown Section (unique keys only)
  ...
  // Landing Cost List - Bulk Operations (unique keys only)
  ...
  // Import Preview Dialog (unique keys only)
