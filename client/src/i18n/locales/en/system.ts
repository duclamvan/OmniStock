const system = {
  ...
  entityId: 'Entity ID',
  metadata: 'Metadata',
  trackAllSystemActivitiesForThisUser: 'Track all system activities for this user',
  noActivityRecorded: 'No activity recorded',
  noActivityRecordedYet: 'No activity recorded yet for this user',
  activityDetails: 'Activity Details',
  viewDetailedInformation: 'View detailed information about this activity',
  ...
  last30Days: '30 days',
  incidents: 'Incidents',
  incidentsDescription: 'Track and manage employee incidents and performance issues',
  ...
  incidentUpdated: 'Incident updated successfully',
  incidentDeleted: 'Incident deleted successfully',
  incidentStatusUpdated: 'Incident status updated',
  deleteIncidentConfirmation: 'Are you sure you want to delete this incident? This action cannot be undone.',
  noIncidents: 'No incidents recorded for this employee',
  addIncidentDescription: 'Record a new incident for this employee',
  editIncidentDescription: 'Update the incident details',
  incidentTitlePlaceholder: 'Brief description of the incident',
  incidentDescriptionPlaceholder: 'Provide detailed description of what happened...',
  incidentNotesPlaceholder: 'Add any additional notes or follow-up actions...',
  ...
  tasks: 'Tasks',
  tasksDescription: 'Warehouse tasks assigned to this employee',
  noTasks: 'No tasks assigned to this employee',
  completedAt: 'Completed At',
  activityDescription: 'Recent system activity by this employee',
  employeeNotFound: 'Employee Not Found',
  employeeNotFoundDescription: 'The employee you are looking for does not exist or has been removed.',
  notes: 'Notes',
  title: 'Title',
  type: 'Type',
  severity: 'Severity',
