const imports = {
  ...
  internalCarrierUrlOrName: 'Internal Carrier (URL or Name)',
  trackingUrl: 'Tracking URL',
  enterInternalTracking: 'Enter internal tracking number',
  enterInternalCarrier: 'Enter internal carrier',
  enterInternalCarrierUrlOrName: 'e.g. https://tracking.com or Carrier Name',
  ...
  movedToInternationalTransit: 'Moved to International Transit',
  youCanAddTrackingLater: 'You can add tracking details later from International Transit',
  viewPendingShipments: 'View Pending Shipments',
  enterShipmentDetails: 'Enter Shipment Details',
  carrierPlaceholder: 'e.g. DHL, FedEx, UPS',
  trackingNumberPlaceholder: 'Enter tracking number',
  originPlaceholder: 'e.g. China',
  ...
  selectEtaDate: 'Select expected delivery date',
  incoming: 'Incoming',
  fillLater: 'Fill Later',
  createShipment: 'Create Shipment',
  creating: 'Creating...',
  shipmentCreatedSuccessfully: 'Shipment created successfully',
  shipmentCreationFailed: 'Failed to create shipment',
  carrierAndTrackingRequired: 'Carrier and tracking number are required',
  ...
  confirmDeleteSelected: 'Are you sure you want to delete {{count}} selected item(s)? This action cannot be undone.',
  ...
  totalCostCZK: 'Total Cost (CZK)',
  productCost: 'Product Cost',
  grandTotal: 'Grand Total',
  grandTotalCZK: 'Grand Total (CZK)',
  serverCalculated: 'Server Calculated',
  estimated: 'Estimated',
  landingCostsFromServer: 'Landing costs calculated by server with full cost aggregation.',
  landingCostsEstimated: 'Landing costs are estimated. Final values will be calculated upon receiving.',
  totals: 'Totals',
  ...
  noArchivedShipmentsDescription: 'Archived shipments will appear here after weekly archiving.',
  ...
  shipment: 'shipment',
  shipmentsPlural: 'shipments',
  restore: 'Restore',
  shipmentArchived: 'Shipment archived',
  shipmentArchivedSuccess: 'All active shipments have been archived successfully.',
  shipmentUnarchived: 'Shipment restored',
  ...
  undo: 'Undo',
  unpackUndone: 'Unpack has been undone',
  failedToUndoUnpack: 'Failed to undo unpack',
  ...
  showAll: 'Show All',
  reset: 'Reset',
  coreColumns: 'Core Columns',
  costColumns: 'Cost Columns',
  detailedColumns: 'Detailed Columns',
  // Column IDs (unique prefixed keys to avoid conflicts)
  colProduct: 'Product',
  colUnits: 'Units',
  colPurchPrice: 'Purchase Price',
  colChgKg: 'Chargeable Kg',
  colFreight: 'Freight',
  colDuty: 'Duty',
  colBrokerage: 'Customs/Brokerage',
  colInsurance: 'Insurance',
  colPackaging: 'Packaging',
  colOther: 'Other',
  colLandingCost: 'Landing Cost/Unit',
  ...
  fromPurchaseOrders: 'From linked purchase orders',
  includesPOShipping: 'Includes PO shipping',
  ...
  addProductWithVariants: 'Add product with {{count}} variants',
  productWithVariantsAdded: '{{name}} added with {{count}} variants',
  includedVariants: '{{count}} variants included',
  variants: 'variants',
  ...
  applyToAllCount: 'Apply to All ({{count}})',
