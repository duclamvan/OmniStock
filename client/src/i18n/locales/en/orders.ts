const orders = {
  ...
  capturePreviewDesc: 'Review the invoice before downloading',
  downloadImage: 'Download Image',
  captureError: 'Capture Error',
  captureErrorDesc: 'Failed to capture order image',
  ...
  customerPriceApplied: 'Customer Pricing Applied',
  customerPriceAppliedDesc: 'Custom price of {{price}} {{currency}} applied',
  customerPricesAppliedCount: 'Applied custom pricing to {{count}} item(s)',
