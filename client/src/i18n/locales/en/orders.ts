const orders = {
  ...
  importOrdersDescription: 'Upload an Excel file to import orders in bulk. Use the template to ensure correct formatting.',
  ...
  importTemplate: 'Orders Import Template',
  ...
  startDate: 'Start',
  endDate: 'End',
  searchPlaceholderExtended: 'Search by order, customer, tracking, notes...',
  ...
  fieldError_customerId: 'Customer',
  fieldError_customerId_required: 'Please select a customer for this order',
  fieldError_grandTotal: 'Grand Total',
  fieldError_grandTotal_required: 'Order total is required',
  fieldError_grandTotal_invalid: 'Please enter a valid total amount',
  fieldError_currency: 'Currency',
  fieldError_currency_required: 'Please select a currency',
  fieldError_shippingMethod: 'Shipping Method',
  fieldError_shippingMethod_required: 'Please select a shipping method',
  fieldError_paymentMethod: 'Payment Method',
  fieldError_paymentMethod_required: 'Please select a payment method',
  fieldError_orderStatus: 'Order Status',
  fieldError_orderStatus_required: 'Please select an order status',
  fieldError_paymentStatus: 'Payment Status',
  fieldError_paymentStatus_required: 'Please select a payment status',
  fieldError_priority: 'Priority',
  fieldError_priority_required: 'Please select a priority level',
  fieldError_shippingAddressId: 'Shipping Address',
  fieldError_shippingAddressId_required: 'Please select or add a shipping address',
  fieldError_notes: 'Notes',
  fieldError_notes_invalid: 'Please enter valid notes',
  fieldError_shippingCost: 'Shipping Cost',
  fieldError_shippingCost_invalid: 'Please enter a valid shipping cost',
  fieldError_discountValue: 'Discount',
  fieldError_discountValue_invalid: 'Please enter a valid discount amount',
  fieldError_taxRate: 'Tax Rate',
  fieldError_taxRate_invalid: 'Please enter a valid tax rate',
  fieldError_codAmount: 'COD Amount',
  fieldError_codAmount_invalid: 'Please enter a valid cash on delivery amount',
  fieldError_adjustment: 'Adjustment',
  fieldError_adjustment_invalid: 'Please enter a valid adjustment amount',
  fieldError_required: 'This field is required',
  fieldError_invalid: 'Please enter a valid value',
  creating: 'Creating...',
  ...
  reminderTiming: 'When to Notify',
  reminderTimingHint: 'Select when to send reminders relative to arrival',
  daysBefore_one: '{{count}} day before',
  daysBefore_other: '{{count}} days before',
  sameDay: 'Same day',
  daysAfter_one: '{{count}} day after',
  daysAfter_other: '{{count}} days after',
  ...
  trackingUrlCopied: 'Tracking URL Copied',
  trackingUrlCopiedDesc: 'Tracking URL has been copied to clipboard',
  ...
  uploadCSVDescription: 'Upload your bank transaction export file (CSV format with semicolon delimiter)',
  dragDropCSV: 'Drag and drop a CSV file here',
  ...
  fuzzyMatchingDescription: 'Match payments without order ID by amount (±tolerance) and date (±30 days)',
  amountTolerance: 'Amount Tolerance',
  amountToleranceDescription: 'Maximum difference allowed between payment and order amount',
  importAndMatch: 'Import & Match',
  matching: 'Matching...',
  matchingResults: 'Matching Results',
  autoMatched: 'Auto-Matched',
  needsReview: 'Needs Review',
  unmatched: 'Unmatched',
  noAutoMatches: 'No automatic matches found',
  noReviewItems: 'No items require manual review',
  allPaymentsMatched: 'All payments have been matched!',
  ...
  selectOrder: 'Select Matching Order',
  ...
  paymentsConfirmedDesc: '{{count}} payment(s) have been marked as paid',
