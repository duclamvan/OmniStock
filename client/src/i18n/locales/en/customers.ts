const customers = {
  ...
  customerBlacklisted: 'Customer has been blacklisted',
  ...
  facebookFetchFailed: 'Facebook Profile Fetch Failed',
  couldNotFetchFacebookProfile: 'Could not retrieve Facebook profile data',
  noProfileDataFound: 'No profile data found. The profile may be private or unavailable.',
  foundProfile: 'Found profile for {{name}}',
  profileDataRetrieved: 'Profile data retrieved successfully',
