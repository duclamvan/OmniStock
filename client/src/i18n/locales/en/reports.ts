const reports = {
  ...
  dashboardSummaryDesc: 'Real-time overview of inventory health and key metrics',
  ...
  stockDistributionAnalytics: 'Stock Distribution Analytics',
  stockDistributionAnalyticsDesc: 'Visual breakdown of inventory health and value distribution',
  stockHealthDistribution: 'Stock Health Distribution',
  stockValueByCategory: 'Stock Value by Category',
  stockMovementTrends: 'Stock Movement Trends',
  stockMovementTrendsDesc: 'Track stock additions, removals, and adjustments over time',
  ...
  strategicReorderingInsights: 'Strategic Reordering Insights',
  strategicReorderingDesc: 'Products requiring attention based on stock levels and demand patterns',
  ...
  createPO: 'Create PO',
  noReorderRequired: 'No products require reordering at this time',
  fastMovingProducts: 'Fast Moving Products',
  fastMovingProductsDesc: 'Top performing products by units sold in the selected period',
  unitsSoldLabel: 'Units Sold',
  velocity: 'Velocity',
  noFastMovingProducts: 'No fast-moving products data available',
  noLowStockItems: 'No low stock items found',
  estimatedStockoutDays: 'Est. Stockout',
  ...
  reorderAlertsDesc: 'Products that need to be reordered based on minimum stock levels',
  noReorderAlerts: 'No reorder alerts',
  colorTrendTracking: 'Color Trend Tracking',
  colorTrendDesc: 'Sales performance analysis by color variants for Gel Polish category',
  colorVariant: 'Color Variant',
  topSeller: 'Top Seller',
  popular: 'Popular',
  noColorTrendData: 'No color trend data available',
  deadStockReport: 'Dead Stock Report',
  deadStockDesc: 'Products with no sales in the specified number of days',
  daysThreshold: 'Days Threshold',
  daysSinceLastSale: 'Days Since Last Sale',
  productName: 'Product Name',
  highestValueInventory: 'Highest Value Inventory',
  unitPrice: 'Unit Price',
  reorderRate: 'Reorder Rate',
  
  // Business Report / Business Intelligence
  businessReport: 'Business Report',
  businessReportDesc: 'AI-powered business analysis for cash flow optimization and profit management',
  generateNewReport: 'Generate New Report',
  generatingBusinessReport: 'Generating business report with AI analysis...',
  ...
  failedToGenerateReport: 'Failed to generate business report',
  noBusinessReportYet: 'No business report generated yet',
  generateFirstReport: 'Generate your first business report to get AI-powered insights about your cash flow, inventory health, and profit optimization opportunities.',
  lastGenerated: 'Last Generated',
  viewFullReport: 'View Full Report',
  aiPoweredInsights: 'AI-Powered Insights',
  cashFlowSummary: 'Cash Flow Summary',
  topSellers: 'Top Sellers',
  reorderUrgent: 'Reorder Urgent',
