const settings = {
  ...
  autoAssignOrdersToWarehouseDescription: 'Automatically assign orders to default warehouse',
  autoCreatePackingLists: 'Auto-create Packing Lists',
  autoCreatePackingListsDescription: 'Generate packing lists when order is confirmed',
  autoCalculateShipping: 'Auto-calculate Shipping',
  autoCalculateShippingDescription: 'Calculate shipping costs automatically',
  requireBarcodeScanForPicking: 'Require Barcode Scan for Picking',
  requireBarcodeScanForPickingDescription: 'Force barcode scan during picking process',
  ...
  requireShippingAddressDescription: 'Orders must have a shipping address',
  requirePhoneNumber: 'Require Phone Number',
  requirePhoneNumberDescription: 'Customer phone number required',
  allowNegativeStock: 'Allow Negative Stock',
  allowNegativeStockDescription: 'Allow orders even if stock is insufficient',
  ...
  autoSendShippingNotificationDescription: 'Email customer when order ships',
  autoSendDeliveryNotification: 'Auto-send Delivery Notification',
  autoSendDeliveryNotificationDescription: 'Email customer when order is delivered',
  autoUpdateStockOnOrder: 'Auto-update Stock on Order',
  autoUpdateStockOnOrderDescription: 'Reduce inventory when order is placed',
  autoCreateReturnRequest: 'Auto-create Return Request',
  autoCreateReturnRequestDescription: 'Automatically create return requests',
