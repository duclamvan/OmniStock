const settings = {
  ...
  pplPackageType: 'PPL Package Type',
  pplPackageTypeDescription: 'Select the default PPL service type for shipping labels',
  pplPrivate: 'PPL PARCEL CZ PRIVATE',
  pplPrivateDescription: 'For private/home addresses (e-shop customers)',
  pplBusiness: 'PPL PARCEL CZ BUSINESS',
  pplBusinessDescription: 'For business addresses (B2B)',
  pplSmart: 'PPL PARCEL CZ SMART',
  pplSmartDescription: 'For ParcelShop/ParcelBox delivery',
  pplTieredPricing: 'PPL CZ Weight-Based Pricing (CZK)',
  pplTieredPricingNote: 'Fixed pricing tiers based on package weight - prices are set by PPL contract',
  upToWeight: 'up to {{weight}} kg',
  pplMaxWeightDescription: 'Maximum weight limit for PPL packages (up to 31.5kg)',
  pplMaxDimensionsDescription: 'Maximum dimensions 120×60×60 cm, girth+length max 360 cm',
  pplSurcharges: 'Additional Surcharges',
  ...
  insurancePercent: 'Insurance Rate',
  ofDeclaredValue: '% of declared value',
  minimumInsuranceFee: 'Minimum Fee',
  insuranceDescription: 'Insurance fee based on declared shipment value (higher of percentage or minimum)',
