const common = {
  ...
  cashOutAll: 'Cash Out All',
  cashOutNotesPlaceholder: 'Reason for cash out...',
  cashOutRecorded: 'Cash out of {{amount}} recorded successfully',
  availableBalance: 'Available Balance',
  totalSales: 'Total Sales',
  averageSale: 'Average Sale',
  transactions: 'transactions',
  salesHistory: 'Sales History',
  searchSales: 'Search sales by ID, customer, or notes...',
  allPayments: 'All Payments',
  saleDetails: 'Sale Details',
  editSale: 'Edit Sale',
  editSaleDescription: 'Update payment method or notes for this sale',
  deleteSale: 'Delete Sale',
  deleteSaleConfirmation: 'Are you sure you want to delete this sale? This action cannot be undone.',
  saleDeleted: 'Sale deleted successfully',
  saleUpdated: 'Sale updated successfully',
  qrPayment: 'QR Payment',
  invalidAmount: 'Please enter a valid amount',
  insufficientCash: 'Amount exceeds available cash balance',
  ...
  locationMarkedForDeletion: 'Location marked for deletion',
  undoAvailable: 'You have {{seconds}} seconds to undo',
  deletingLocation: 'Deleting location {{location}}',
  undoCountdown: '{{seconds}}s remaining to undo',
  deletionCancelled: 'Deletion cancelled',
  locationRestored: 'Location has been restored',
  ...
  performance: {
    ...
    trackPerformance: 'Track employee performance and compete for the top spot',
    rankings: 'Rankings',
    ...
    noDataYet: 'No performance data yet',
    startPicking: 'Start picking and packing orders to earn points!',
    you: 'You',
    noRankings: 'No rankings yet',
    beFirst: 'Be the first to earn points!',
    // Badge names
    badgeFirstPick: 'First Pick',
    badgePicker10: 'Picker 10',
    badgePicker50: 'Picker 50',
    badgePicker100: 'Picker 100',
    badgePacker10: 'Packer 10',
    badgePacker50: 'Packer 50',
    badgePacker100: 'Packer 100',
    badgeSpeedDemon: 'Speed Demon',
    badgeStreak5: '5-Day Streak',
