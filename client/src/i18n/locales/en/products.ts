const products = {
  ...
  replenishmentMethodDescription: 'Choose how this product is restocked - purchased from suppliers or manufactured in-house',
  replenishmentMethodUpdated: 'Replenishment method updated successfully',
  replenishmentMethodError: 'Failed to update replenishment method',
  buy: 'Buy',
  make: 'Make',
  ...
  maxBuildable: 'Max Buildable',
  canFullyBuild: 'Can Fully Build',
  missingIngredients: 'Missing Ingredients',
  calculateRequirements: 'Calculate Requirements',
  calculateRequirementsDescription: 'Select a manufacturable product and quantity to see required ingredients',
  calculateRequirementsError: 'Failed to calculate requirements',
  productionPlanner: 'Production Planner',
  productionPlannerDescription: 'Plan production runs and calculate ingredient requirements',
  noIngredientsYet: 'No ingredients added yet',
  addIngredientToStart: 'Add ingredients to define the recipe for manufacturing this product',
  recipeDescription: 'Ingredients required to manufacture one unit of this product',
  noProductsFound: 'No products found',
  selectProduct: 'Select Product',
  selectProductPlaceholder: 'Choose a manufacturable product',
  quantityToBuild: 'Quantity to Build',
  calculate: 'Calculate',
  buildStatus: 'Build Status',
  requestedQty: 'Requested Qty',
  ingredientRequirements: 'Ingredient Requirements',
  ingredientRequirementsFor: 'Required ingredients to build {{qty}} units of {{product}}',
  requiredQty: 'Required Qty',
  availableStock: 'Available Stock',
  status: 'Status',
  sufficient: 'Sufficient',
  insufficient: 'Insufficient',
  procurementNeeded: 'Procurement Needed',
  procurementNeededDescription: '{{count}} ingredient(s) have insufficient stock and need to be procured',
