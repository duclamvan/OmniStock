const products = {
  ...
  enableBulkUnit: 'Enable Packaging Unit',
  enableBulkUnitHelp: 'Allow selling in larger packaged units (e.g., cartons, pallets)',
  bulkUnitName: 'Packaging Unit Name',
  bulkUnitNamePlaceholder: 'e.g., carton, pallet, case',
  bulkUnitQty: 'Items per Packaging Unit',
  bulkUnitQtyHelp: 'How many individual items are in one packaging unit',
  bulkPriceCzk: 'Packaging Unit Price (CZK)',
  bulkPriceEur: 'Packaging Unit Price (EUR)',
  allowBulkSales: 'Allow Packaging Unit Sales',
  allowBulkSalesHelp: 'Enable customers to order full packaging units (cartons/pallets)',
  ...
  variants: {
    ...
    locationCodePlaceholder: 'e.g., A-01-01',
    locationCodeHelper: "Leave blank to use parent product's location",
    seriesLocationCode: 'Location Code',
    seriesLocationCodePlaceholder: 'e.g., WH1-A1-R1',
    seriesLocationPattern: 'Location Pattern (Optional)',
    seriesLocationPatternPlaceholder: 'e.g., WH1-A<1-10>-R1',
    seriesLocationPatternHelp: "Use <start-end> to generate location series. Leave blank to use product's warehouse location.",
    addVariantSeriesButton: 'Add Variant Series',
    bulkImportButton: 'Import List',
    bulkImportTitle: 'Import Variants',
    bulkImportDescription: 'Paste a list of variant names or import from CSV/text file',
    bulkImportLabel: 'Variant Names',
    bulkImportPlaceholder: 'One variant per line, or CSV format:\nRed\nBlue\nGreen\n\nOr with details (name,qty,location,barcode):\nRed,10,WH1-A1-R1,123456\nBlue,5,WH1-A1-R2,123457',
    bulkImportHelp: 'Enter one variant name per line. Optionally use CSV format: name,quantity,location,barcode',
    bulkImportCount: '{{count}} variant(s) will be imported',
    bulkImportDefaultQuantity: 'Default Quantity',
    bulkImportDefaultLocation: 'Default Location',
    bulkImportSubmit: 'Import Variants',
    ...
    skuPlaceholder: 'Enter variant SKU',
    skuAutoGenerated: 'Auto-generated from parent SKU and variant name. You can edit it.',
    tableHeaders: {
      image: 'Image',
      name: 'Name',
      sku: 'SKU',
  ...
  toasts: {
    ...
    seriesFormatError: 'Invalid series pattern format. Use pattern like Size <1-10>',
    variantsAdded: '{{count}} variant(s) added successfully',
    variantsDeleted: '{{count}} variant(s) deleted',
    variantAdded: 'Variant added successfully',
    enterVariantNames: 'Please enter at least one variant name',
    bulkImportTooMany: 'Too many variants: {{count}} exceeds maximum of {{max}}',
    noValidVariants: 'No valid variant names found in the input',
    variantsImported: '{{count}} variant(s) imported successfully',
