const inventory = {
  ...
  warehouseLabelDesc: 'Preview and print shelf label for thermal printer (100mm × 30mm)',
  ...
  bundleNameEn: 'Bundle English Name',
  bundleNameEnPlaceholder: 'e.g., Big Carton Pack',
  bundleNameVi: 'Bundle Vietnamese Name',
  ...
  overstockedShort: 'Overstocked',
  slowMovingShort: 'Slow Moving',
  incoming: 'Incoming',
  ...
  suggest: 'Suggest',
  noUrgentReorders: 'No urgent reorders needed',
  noUpcomingReorders: 'No upcoming reorders needed',
  noClearanceCandidates: 'No clearance candidates',
