const financial = {
  ...
  posSystem: 'Davie Supply POS System',
  warehouse: 'Warehouse',
  ...
  cartIsEmptyMessage: 'Cart is empty',
  scanOrClickToAdd: 'Scan or click products to add',
  editNotes: 'Edit Notes',
  addNotes: 'Add Notes',
  processing: 'Processing...',
  payAmount: 'Pay {{amount}}',
  pressToSelectMethod: 'Press 1-6 to select method',
  card: 'Card',
  comingSoon: '(Soon)',
  privatKonto: 'Privat Konto',
  invoiceTransfer: 'Invoice Transfer',
  insufficientAmount: 'Insufficient Amount',
  insufficientAmountDesc: 'Cash received ({{received}}) is less than total ({{total}})',
  invalidDiscount: 'Invalid Discount',
  percentageCannotExceed100: 'Percentage cannot be greater than 100%',
  discountCannotExceedSubtotal: 'Discount cannot be greater than subtotal',
  ...
  walkInCustomerTapToSelect: 'Walk-in Customer (tap to select)',
  noCustomerRecord: 'No customer record',
  customer: 'Customer',
  selectCustomerForPayLater: 'Select Customer for Pay Later',
  searchPayLaterHint: 'Search by name, Facebook name, email, phone, or company',
  backToPaymentOptions: 'Back to Payment Options',
  amountInCzk: 'Amount in CZK',
  item: 'item',
  orderNotes: 'Order Notes',
  addOrderNotesPlaceholder: 'Add any notes for this order... (Ctrl+Enter to save)',
  saveNotes: 'Save Notes',
  applyDiscount: 'Apply Discount',
  percentage: 'Percentage',
  fixedAmount: 'Fixed Amount',
  enterPercentagePlaceholder: 'Enter percentage (e.g., 10)',
