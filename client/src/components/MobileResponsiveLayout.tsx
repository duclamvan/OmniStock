  ...
  const navigation = [
    // Operational Section (Mobile-optimized for warehouse employees)
    {
      ...
      items: [
        ...
        {
          name: t('manufacturing:simpleConversion', 'Simple Conversion'),
          href: "/manufacturing/simple-conversion",
          icon: Factory,
          color: "text-orange-600 dark:text-orange-400",
          description: t('manufacturing:convertMaterials', 'Convert raw materials')
        },
        {
          name: t('common:stock'),
          href: "/stock",
          ...
          {!collapsed && (
            <>
              <div
                ...
                className={cn(
                  "mx-1 px-3 py-2.5 cursor-pointer rounded-md transition-colors duration-150",
