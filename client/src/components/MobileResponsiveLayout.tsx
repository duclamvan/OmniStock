        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            ...
            <SheetContent side="left" className="w-72 p-0 flex flex-col h-full">
              ...
              <nav className="p-4 space-y-2 overflow-y-auto flex-1 pb-4">
                <NavLinks />
              </nav>
              {/* Fixed User Profile & Settings Section */}
                ...
                <div className="p-4 space-y-2">
                  <div className="flex items-center gap-3 px-3 py-2 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-semibold">ronak_03</p>
                  ...
                  <div className="space-y-1">
                    ...
                    <Button
                      variant="ghost"
                      className="w-full justify-start text-left px-3 py-2 rounded-md text-red-600 hover:text-red-700 hover:bg-red-50"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
