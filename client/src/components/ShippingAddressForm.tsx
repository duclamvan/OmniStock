    ...
    <div className="space-y-4 border border-blue-200 bg-blue-50 p-4 rounded-lg" data-testid="form-new-address">
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {showShippingAddressDropdown && (
            <div className="absolute top-full left-0 right-0 mt-1 border dark:border-slate-700 rounded-md shadow-lg bg-white dark:bg-slate-800 max-h-72 overflow-y-auto z-50">
              {isLoadingShippingSearch ? (
                ...
                <>
                  <div className="p-2 bg-slate-50 dark:bg-slate-700 border-b dark:border-slate-600 text-xs text-slate-600 dark:text-slate-400">
                  ...
                  {shippingAddressSuggestions.map((suggestion, index) => (
                    <div
                      key={index}
                      className="p-3 hover:bg-blue-50 dark:hover:bg-blue-900/30 cursor-pointer border-b dark:border-slate-700 last:border-b-0 transition-colors"
      ...
      <div>
        ...
        <Input
          ...
          className={labelManuallyEdited ? "bg-white dark:bg-slate-800" : "bg-slate-50 dark:bg-slate-900"}
          onChange={(e) => {
