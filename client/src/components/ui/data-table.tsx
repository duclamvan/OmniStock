            ...
            {paginatedData.length === 0 ? (
              ...
              paginatedData.map((item) => {
                ...
                if (expandable && isExpanded) {
                  elements.push(
                    <TableRow key={`${key}-expanded-1`} className="hover:bg-transparent">
                      <TableCell
                        ...
                        className="bg-white dark:bg-slate-950 p-4 border-l-4 border-l-blue-500"
                      >
                  ...
                  elements.push(
                    <TableRow key={`${key}-expanded-2`} className="hover:bg-transparent">
                      <TableCell 
                        colSpan={displayColumns.length + (bulkActions ? 1 : 0) + 1} 
                        className="p-0 h-px bg-slate-300 dark:bg-slate-700"
                      />
                    </TableRow>
                  );
                }
