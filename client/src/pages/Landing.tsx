...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 overflow-x-hidden">
      <div className="container mx-auto px-4 py-8 sm:py-16">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-slate-100 mb-3 sm:mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-16">
          <Card className="text-center">
            <CardHeader>
              <div className="mx-auto w-12 h-12 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.keyFeatures.vietnameseSupport.description')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.keyFeatures.multiCurrency.description')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.keyFeatures.notifications.description')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.keyFeatures.barcode.description')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.keyFeatures.reports.description')}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.keyFeatures.security.description')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="text-center mt-8 sm:mt-16 text-slate-500 dark:text-slate-400 text-sm sm:text-base px-4">
