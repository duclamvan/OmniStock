...
export default function Register() {
  ...
  const handleVerifyAndRegister = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/auth/register-with-phone", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ name, phone, code: verificationCode }),
      });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950 p-4 overflow-x-hidden">
