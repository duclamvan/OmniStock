...
import { ArrowLeft, Save, Box, Layers, Shield, Package, Upload, X, FlaskConical, Loader2, ChevronDown, ChevronUp, Link2, Check, AlertCircle, Sparkles } from "lucide-react";
    ...
    <div className="container mx-auto py-3 md:py-6 px-2 md:px-4 max-w-5xl pb-24 md:pb-6">
      ...
      <Card className="border-0 md:border shadow-none md:shadow-sm">
        <CardHeader className="px-3 md:px-6 py-3 md:py-6">
          <CardTitle className="text-xl md:text-2xl">{t('editPackingMaterial')}</CardTitle>
              ...
              <Collapsible open={openSections.properties} onOpenChange={() => toggleSection('properties')}>
                ...
                <CollapsibleContent>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Switches - 2 column grid on mobile, 3 on desktop */}
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 md:p-4">
                            <div className="space-y-0.5">
                              ...
                              <FormDescription className="text-xs">{t('activeDescription')}</FormDescription>
                            </div>
                            <FormControl>
                              <Switch
                                checked={field.value}
