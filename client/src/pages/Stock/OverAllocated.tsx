            ...
            <Card className="mb-6 border-red-200 dark:border-red-800">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Over-Allocated Items</p>
                    <p className="text-3xl font-bold text-red-600 dark:text-red-400">{items.length}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Shortfall</p>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4">
                          ...
                          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Ordered Quantity</p>
                            <p className="text-xl font-bold text-blue-600 dark:text-blue-400">
                              {item.orderedQuantity}
                            </p>
                          </div>
                          <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Shortfall</p>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Link href={`/stock`}>
                            <Button size="sm" className="bg-green-600 hover:bg-green-700 text-white" data-testid={`button-add-stock-${item.productId}`}>
                              <TrendingUp className="h-4 w-4 mr-1" />
                              Add Stock
                            </Button>
                          </Link>
                          <Link href={`/orders`}>
                            <Button size="sm" variant="outline" data-testid={`button-view-orders-${item.productId}`}>
                              View Related Orders
                            </Button>
                          </Link>
                        </div>
