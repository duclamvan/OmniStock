    ...
    if (canDirectPrint && products.length > 0) {
      ...
      for (const product of products) {
        ...
        if (currentLabelSize === 'large') {
          qzLabelHtml = `
            <div style="width:148mm;height:105mm;display:grid;grid-template-columns:30mm 1fr;grid-template-rows:1fr 24mm;background:white;color:black;overflow:hidden;border:3px solid black;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
              ...
              <div style="padding:4mm 5mm 3mm 5mm;display:flex;flex-direction:column;justify-content:center;gap:2mm;overflow:hidden;">
                ...
                ${vietnameseName !== product.name ? `<div style="font-size:20pt;font-weight:600;line-height:1.1;letter-spacing:0.3pt;text-transform:uppercase;color:#444;word-break:break-word;border-top:1px solid black;padding-top:2mm;margin-top:1mm;">${product.name}</div>` : ''}
              </div>
              <div style="border-top:3px solid black;display:flex;align-items:center;justify-content:space-between;padding:0 5mm;gap:6mm;background:white;">
                ${hasBulkInfo ? `<div style="font-size:14pt;font-weight:900;color:black;border:2px solid black;padding:2mm 4mm;">${displayText}</div>` : '<div></div>'}
          ...
          qzLabelHtml = `
            <div style="width:100mm;height:30mm;display:flex;flex-direction:row;align-items:stretch;background:white;color:black;overflow:hidden;border:2px solid black;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
              <div style="flex-shrink:0;width:22mm;display:flex;align-items:center;justify-content:center;padding:1.5mm;background:white;border-right:2px solid black;">
                <img src="${qrDataUrl}" style="width:19mm;height:19mm;" alt="QR" />
              </div>
              <div style="flex:1;padding:1.5mm 2mm;display:flex;flex-direction:column;justify-content:center;overflow:hidden;min-width:0;background:white;">
                <div style="font-weight:900;font-size:10pt;line-height:1.2;text-transform:uppercase;word-break:break-word;">${vietnameseName}</div>
                <div style="font-size:9pt;font-weight:500;line-height:1.2;color:#1f2937;margin-top:1mm;word-break:break-word;">${product.name}</div>
                ${product.sku ? `<div style="font-size:8pt;line-height:1.1;color:black;margin-top:1mm;font-family:monospace;font-weight:bold;background:#f3f4f6;padding:0.5mm 1mm;display:inline-block;">${product.sku}</div>` : ""}
              </div>
              <div style="flex-shrink:0;width:26mm;display:flex;flex-direction:column;border-left:2px solid black;">
                ...
                ${priceCzk !== null ? `<div style="flex:1;display:flex;align-items:center;justify-content:center;background:white;border-top:1px solid black;"><span style="font-weight:bold;font-size:12pt;line-height:1;color:black;">${priceCzk.toLocaleString("cs-CZ")} Kč</span></div>` : ""}
        ...
        const qzSuccess = await printHtmlViaQZ(qzLabelHtml, currentLabelSize === 'large' ? 148 : 100, currentLabelSize === 'large' ? 105 : 30);
        if (!qzSuccess) {
          allQZSuccess = false;
          break;
        }
