...
- **Discount Management**: Advanced discount system supporting percentage, fixed amount, and "Buy X Get Y" types, with auto-generated IDs, flexible application scopes (product/category/all products), and smart UI for dynamic field display and bidirectional currency conversion. Price previews for both percentage and fixed amount discounts only show when specific product is selected.
