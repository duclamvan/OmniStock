...
export const importPurchases = pgTable("import_purchases", {
  ...
  purchaseTotal: decimal("purchase_total", { precision: 10, scale: 2 }).default(
    "0",
  ),
...
export const purchaseItems = pgTable("purchase_items", {
  ...
  unitGrossWeightKg: decimal("unit_gross_weight_kg", {
    precision: 10,
    scale: 3,
  }),
  ...
  // BOM parent product relationship - for tracking which parent product this item belongs to
  parentProductId: varchar("parent_product_id"), // BOM parent product this item is a component of
...
export const landedCosts = pgTable("landed_costs", {
  ...
  customsDuty: decimal("customs_duty", { precision: 10, scale: 2 }).default(
    "0",
  ),
  taxes: decimal("taxes", { precision: 10, scale: 2 }).default("0"),
  handlingFees: decimal("handling_fees", { precision: 10, scale: 2 }).default(
    "0",
  ),
  insuranceCost: decimal("insurance_cost", { precision: 10, scale: 2 }).default(
    "0",
  ),
  totalLandedCost: decimal("total_landed_cost", {
    precision: 10,
    scale: 2,
  }).notNull(),
...
export const customers = pgTable("customers", {
  ...
  storeCredit: decimal("store_credit", { precision: 10, scale: 2 }).default(
    "0",
...
export const warehouseFinancialContracts = pgTable(
  "warehouse_financial_contracts",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export const layoutBins = pgTable("layout_bins", {
  ...
  layoutId: varchar("layout_id")
    .notNull()
    .references(() => warehouseLayouts.id, { onDelete: "cascade" }),
...
export const products = pgTable("products", {
  ...
  latestLandingCost: decimal("latest_landing_cost", {
    precision: 12,
    scale: 4,
  }),
...
export const packingCartons = pgTable("packing_cartons", {
  id: varchar("id")
    ...
    .default(sql`gen_random_uuid()`),
  name: varchar("name").notNull(),
  innerLengthCm: decimal("inner_length_cm", {
    precision: 10,
    scale: 2,
  }).notNull(),
  innerWidthCm: decimal("inner_width_cm", {
    precision: 10,
    scale: 2,
  }).notNull(),
  innerHeightCm: decimal("inner_height_cm", {
    precision: 10,
    scale: 2,
  }).notNull(),
...
export const orderCartonPlans = pgTable("order_carton_plans", {
  ...
  totalShippingCost: decimal("total_shipping_cost", {
    precision: 10,
    scale: 2,
  }),
...
export const orderCartonItems = pgTable("order_carton_items", {
  ...
  planId: varchar("plan_id")
    .notNull()
    .references(() => orderCartonPlans.id, { onDelete: "cascade" }),
  ...
  productId: varchar("product_id").references(() => products.id),
  quantity: integer("quantity").notNull(),
  itemWeightKg: decimal("item_weight_kg", {
    precision: 10,
    scale: 2,
  }).notNull(),
...
export const services = pgTable("services", {
  ...
  serviceCost: decimal("service_cost", { precision: 10, scale: 2 }).default(
    "0",
  ),
...
export const shipmentCosts = pgTable("shipment_costs", {
  ...
  amountOriginal: decimal("amount_original", {
    precision: 12,
    scale: 4,
  }).notNull(),
...
export const costAllocations = pgTable("cost_allocations", {
  ...
  amountAllocatedBase: decimal("amount_allocated_base", {
    precision: 12,
    scale: 4,
  }).notNull(),
...
// Relations
export const importPurchasesRelations = relations(
  importPurchases,
  ({ many }) => ({
...
export const consolidationsRelations = relations(
  consolidations,
  ({ many }) => ({
...
export const warehouseFinancialContractsRelations = relations(
...
export const shipmentCartonsRelations = relations(
  shipmentCartons,
  ({ one }) => ({
    shipment: one(shipments, {
...
export const insertImportPurchaseSchema = createInsertSchema(
  importPurchases,
...
export const insertConsolidationSchema = createInsertSchema(
  consolidations,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertCustomerShippingAddressSchema = createInsertSchema(
  customerShippingAddresses,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertCustomerBillingAddressSchema = createInsertSchema(
  customerBillingAddresses,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertCustomerBadgeSchema = createInsertSchema(
  customerBadges,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertWarehouseFileSchema = createInsertSchema(
  warehouseFiles,
).omit({ id: true, createdAt: true });
export const insertWarehouseFinancialContractSchema = createInsertSchema(
  warehouseFinancialContracts,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertWarehouseLayoutSchema = createInsertSchema(
  warehouseLayouts,
).omit({ id: true, generatedAt: true, createdAt: true, updatedAt: true });
export const insertLayoutBinSchema = createInsertSchema(layoutBins).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertProductBundleSchema = createInsertSchema(
  productBundles,
).omit({ id: true, bundleId: true, createdAt: true, updatedAt: true });
...
export const insertAiLocationSuggestionSchema = createInsertSchema(
...
export const insertDailySequenceSchema = createInsertSchema(
  dailySequences,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertPackingCartonSchema = createInsertSchema(
  packingCartons,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertOrderCartonPlanSchema = createInsertSchema(
  orderCartonPlans,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertOrderCartonItemSchema = createInsertSchema(
  orderCartonItems,
).omit({ id: true, createdAt: true });
export const insertOrderCartonSchema = createInsertSchema(orderCartons).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export const insertShipmentLabelSchema = createInsertSchema(
  shipmentLabels,
).omit({ id: true, createdAt: true, updatedAt: true });

// Packing Materials schemas
export const insertPackingMaterialSchema = createInsertSchema(
  packingMaterials,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertPackingMaterialUsageSchema = createInsertSchema(
  packingMaterialUsage,
).omit({ id: true, createdAt: true });
export const insertPmSupplierSchema = createInsertSchema(pmSuppliers).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertProductDiscountSchema = createInsertSchema(
  productDiscounts,
).omit({ id: true, createdAt: true, updatedAt: true });
...
export const insertPreOrderSchema = createInsertSchema(preOrders).omit({
  ...
  lastReminderStatus: true,
});
export const insertPreOrderItemSchema = createInsertSchema(preOrderItems).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
export const insertPreOrderReminderSchema = createInsertSchema(
  preOrderReminders,
).omit({ id: true, createdAt: true });
...
export const insertShipmentCartonSchema = createInsertSchema(
  shipmentCartons,
).omit({ id: true, createdAt: true, updatedAt: true });
export const insertCostAllocationSchema = createInsertSchema(
  costAllocations,
).omit({ id: true, createdAt: true });
export const insertProductCostHistorySchema = createInsertSchema(
  productCostHistory,
).omit({ id: true, createdAt: true });
...
export type CustomerShippingAddress =
  typeof customerShippingAddresses.$inferSelect;
export type InsertCustomerShippingAddress = z.infer<
  typeof insertCustomerShippingAddressSchema
>;
export type CustomerBillingAddress =
  typeof customerBillingAddresses.$inferSelect;
export type InsertCustomerBillingAddress = z.infer<
  typeof insertCustomerBillingAddressSchema
>;
...
export type WarehouseFinancialContract =
  typeof warehouseFinancialContracts.$inferSelect;
export type InsertWarehouseFinancialContract = z.infer<
  typeof insertWarehouseFinancialContractSchema
>;
...
export type InsertAiLocationSuggestion = z.infer<
  typeof insertAiLocationSuggestionSchema
>;
...
export type InsertStockAdjustmentRequest = z.infer<
  typeof insertStockAdjustmentRequestSchema
>;

// Stock Adjustment History schemas
export const insertStockAdjustmentHistorySchema = createInsertSchema(
...
export type InsertStockAdjustmentHistory = z.infer<
  typeof insertStockAdjustmentHistorySchema
>;
...
export const insertOrderFulfillmentLogSchema = createInsertSchema(
...
export type InsertPreOrderReminder = z.infer<
  typeof insertPreOrderReminderSchema
>;
...
export type InsertProductCostHistory = z.infer<
  typeof insertProductCostHistorySchema
>;
...
export type InsertOrderFulfillmentLog = z.infer<
  typeof insertOrderFulfillmentLogSchema
>;
...
export function serializePackingPlanToDB(
  uiPlan: UIPackingPlan,
  orderId: string,
) {
  return {
    orderId,
...
export function serializePackingPlanItems(
  uiPlan: UIPackingPlan,
  planId: string,
) {
  const items: Array<{
...
export function deserializePackingPlanFromDB(
  ...
  const cartons = Array.from(cartonMap.entries())
    ...
    .map(([cartonNumber, cartonItems]) => {
      ...
      // Calculate weights
      const totalWeight = cartonItems.reduce(
        (sum, item) => sum + parseFloat(item.itemWeightKg || "0"),
        0,
      );
      const tareWeight = cartonDetail
        ? parseFloat(cartonDetail.tareWeightKg || "0")
        : 0;
      ...
      const cartonVolume = cartonDetail
        ? parseFloat(cartonDetail.innerLengthCm) *
          parseFloat(cartonDetail.innerWidthCm) *
          parseFloat(cartonDetail.innerHeightCm)
        : 0;

      const itemsVolume = cartonItems.reduce(
        (sum, item) => sum + parseFloat(item.itemWeightKg || "0") * 1000,
        0,
      );
      const utilization =
        cartonVolume > 0 ? (itemsVolume / cartonVolume) * 100 : 0;
  ...
  return {
    ...
    suggestions: Array.isArray(dbPlan.suggestions)
      ? (dbPlan.suggestions as string[])
      : [],
...
export const shipmentTracking = pgTable("shipment_tracking", {
  ...
  orderId: varchar("order_id")
    .references(() => orders.id, { onDelete: "cascade" })
    .notNull(),
  cartonId: varchar("carton_id").references(() => orderCartons.id, {
    onDelete: "cascade",
  }),
...
export const insertWarehouseTaskSchema = createInsertSchema(warehouseTasks, {
  ...
  description: z.string().optional(),
  type: z
    .enum(["general", "urgent", "inventory", "maintenance", "other"])
    .default("general"),
...
export const pushSubscriptions = pgTable("push_subscriptions", {
  ...
  notificationTypes: text("notification_types")
    .array()
    .notNull()
    .default(sql`ARRAY['new_order']::text[]`), // Types: new_order, low_stock, task_assigned, shipment_arrived
...
export const insertPushSubscriptionSchema = createInsertSchema(
  pushSubscriptions,
  {
    ...
    notificationTypes: z
      .array(
        z.enum(["new_order", "low_stock", "task_assigned", "shipment_arrived"]),
      )
      .optional(),
  },
).omit({
...
export const insertEmployeeIncidentSchema = createInsertSchema(
  employeeIncidents,
  {
    title: z.string().min(1, "Title is required"),
    description: z.string().optional(),
    type: z
      .enum(["mistake", "safety", "quality", "attendance", "policy", "other"])
      .default("mistake"),
    severity: z
      .enum(["minor", "moderate", "major", "critical"])
      .default("minor"), // critical added for serious incidents
    status: z
...
export type InsertEmployeeIncident = z.infer<
  typeof insertEmployeeIncidentSchema
>;
...
export const insertPermissionSchema = createInsertSchema(permissions, {
  parentSection: z
    .enum(["warehouse_operations", "administration"])
    .default("warehouse_operations"),
